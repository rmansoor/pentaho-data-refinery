 ...
 */
public class GeoContextConfigProviderImpl implements GeoContextConfigProvider {

  protected Dictionary<String, Object> props;

  public GeoContextConfigProviderImpl(Dictionary<String, Object> props) {
    this.props = props;
  }

  public GeoContextConfigProviderImpl() {
    //TODO Figure out how to injects geo properties to this properties object
    props = new Hashtable<>();
    props.put( "geo.dimension.name", "" );
    props.put( "geo.roles","" );
  }
